...
namespace DAC
{
    public class LOTProperty
    {
        ...
        private string create_qty;
        private string oper_in_qty;
        private string start_flag;
        private string start_qty;
        ...
        [DisplayName("수량")]
        public string LOT_QTY { get { return lot_qty; } set { lot_qty = value; } }
        [DisplayName("생성 수량")]
        public string CREATE_QTY { get { return create_qty; } set { create_qty = value; } }
        [DisplayName("공정 투입 수량")]
        public string OPER_IN_QTY { get { return oper_in_qty; } set { oper_in_qty = value; } }
        [DisplayName("작업 시작 여부")]
        public string START_FLAG { get { return start_flag; } set { start_flag = value; } }
        [DisplayName("작업 시작 수량")]
        public string START_QTY { get { return start_qty; } set { start_qty = value; } }
        ...
        [DisplayName("생산 시간")]
        public string PRODUCTION_TIME { get { return production_time; } set { production_time = value; } }
        [DisplayName("LOT 생성 시간")]
        public string CREATE_TIME { get { return create_time; } set { create_time = value; } }
        [DisplayName("공정 투입 시간")]
        public string OPER_IN_TIME { get { return oper_in_time; } set { oper_in_time = value; } }
        [DisplayName("작업지시")]
        ...
        public string LOT_DELETE_TIME { get { return lot_delete_time; } set { lot_delete_time = value; } }
        ...
        public string LAST_TRAN_TIME { get { return last_tran_time; } set { last_tran_time = value; } }
        ...
        public string LAST_HIST_SEQ { get { return last_hist_seq; } set { last_hist_seq = value; } }
    ...
    public class OperationCode
    {
        public List<string> GetOperationCode()
        {
            ...
            List<string> productType = dac.GetOperationCode();
    ...
    public class StoreCode
    {
        public List<string> GetStoreCode()
        {
            ...
            LOTDAC dac = new LOTDAC();
            List<string> productType = dac.GetStoreCode();
            return productType; //한번에 다 가져올까 말까 
        }
    }
    ...
    public class ProductCode
    {
        public List<string> GetProductCode()
        {
            ...
            LOTDAC dac = new LOTDAC();
            List<string> productType = dac.GetProductCode();
            return productType; //한번에 다 가져올까 말까 
        }
    }
