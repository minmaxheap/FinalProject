...
namespace NiceWEB.Models
{
 ...
 SPEC_LSL, SPEC_TARGET, SPEC_USL, INSPECT_VALUE, INSPECT_RESULT,  TRAN_CODE,TRAN_USER_ID
 FROM (	
 ...
 SPEC_LSL, SPEC_TARGET, SPEC_USL, INSPECT_VALUE, INSPECT_RESULT, TRAN_CODE,TRAN_USER_ID, row_number() over(order by  LOT_ID) as RowNum
