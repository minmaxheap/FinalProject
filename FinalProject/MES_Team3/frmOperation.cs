...
namespace MES_Team3
{
    public partial class frmOperation : MES_Team3.BaseForms.Base1_1
    {
        ...
        private void frmProduct1_Load(object sender, EventArgs e)
        {
            ...
            DataGridViewUtil.AddGridTextColumn(csDataGridView1, "공정", "Process_CODE");
            DataGridViewUtil.AddGridTextColumn(csDataGridView1, "공정명", "PRODUCT_NAME");
            DataGridViewUtil.AddGridTextColumn(csDataGridView1, "불량 입력", "PRODUCT_TYPE");
            DataGridViewUtil.AddGridTextColumn(csDataGridView1, "검사 데이터 입력", "CUSTOMER_CODE");
            DataGridViewUtil.AddGridTextColumn(csDataGridView1, "자재 사용", "VENDOR_CODE");
