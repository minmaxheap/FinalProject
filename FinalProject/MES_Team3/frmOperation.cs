...
namespace MES_Team3
{
    public partial class frmOperation : MES_Team3.Base1_1
    {
        ...
        private void frmProduct1_Load(object sender, EventArgs e)
        {
            ...
            DataGridViewUtil.AddGridTextColumn(csDataGridView1, "공정", "OPERATION_CODE", DataGridViewContentAlignment.MiddleCenter,80);
            ...
            DataGridViewUtil.AddGridTextColumn(csDataGridView1, "검사 데이터 입력", "CHECK_INSPECT_FLAG", DataGridViewContentAlignment.MiddleCenter, width: 150);
            ...
            csDataGridView1.Columns[0].AutoSizeMode = DataGridViewAutoSizeColumnMode.;
