...
namespace MES_Team3
{
    public partial class frmInspectOperRelation : MES_Team3.Base3_1
    {
		...
		private void frmInspectOperRelation_Load(object sender, EventArgs e)
        {
			...
			DataGridViewUtil.AddGridTextColumn(csDataGridView1, "검사 데이터 입력", "CHECK_INSPECT_FLAG", DataGridViewContentAlignment.MiddleCenter, width: 160);
			...
			csDataGridView1.Columns[2].FillWeight = 120;
			csDataGridView1.Columns[4].FillWeight = 120;
			csDataGridView1.Columns[6].FillWeight = 160;
			csDataGridView1.Columns[8].FillWeight = 160;
			OP_Grid();
			INSPECT_Grid();
